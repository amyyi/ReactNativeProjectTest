...
import static io.wazo.callkeep.Constants.ACTION_TOGGLE_SPEAKER;
...
public class RNCallKeepModule extends ReactContextBaseJavaModule {
    ...
    public void setMutedCall(String uuid, boolean shouldMute) {
        ...
        AudioManager audioManager = (AudioManager) this.getAppContext().getSystemService(Context.AUDIO_SERVICE);
        audioManager.setMicrophoneMute(shouldMute);
    }
    /**
    ...
    public void toggleAudioRouteSpeaker(String uuid, boolean routeSpeaker) {
        Log.d(TAG, "setMutedCall, toggleAudioRouteSpeaker, uuid: " + uuid + ", routeSpeaker: " + (routeSpeaker ? "true" : "false"));
        Connection conn = VoiceConnectionService.getConnection(uuid);
        if (conn == null) {
            return;
        }
    ...
    private boolean hasPhoneAccount() {
        return isConnectionServiceAvailable() && hasPermissions() &&
                telecomManager != null && telecomManager.getPhoneAccount(handle) != null && telecomManager.getPhoneAccount(handle).isEnabled();
    }
    ...
    private void registerReceiver() {
        if (!isReceiverRegistered) {
            ...
            intentFilter.addAction(ACTION_TOGGLE_SPEAKER);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (intent.getAction()) {
                ...
                case ACTION_TOGGLE_SPEAKER:
                    args.putBoolean("isSpeaker", Boolean.parseBoolean(attributeMap.get("isSpeaker")));
                    args.putString("callUUID", attributeMap.get(EXTRA_CALL_UUID));
                    sendEventToJS("RNCallKeepDidToggleSpeakerAction", args);
                    break;

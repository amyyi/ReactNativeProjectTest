...
public class VoiceConnection extends Connection {
    ...
    public void onCallAudioStateChanged(CallAudioState state) {
        ...
        boolean isSpeaker = state.getRoute() == CallAudioState.ROUTE_SPEAKER;
        if (isSpeaker != this.isSpeaker) {
            this.isSpeaker = isSpeaker;
            handle.put("isSpeaker", String.valueOf(this.isSpeaker));
            sendCallRequestToActivity(ACTION_TOGGLE_SPEAKER, handle);
        }
    }

...
const RNCallKeepDidToggleSpeakerAction = 'RNCallKeepDidToggleSpeakerAction';
...
const didToggleSpeakerAction = handler =>
  eventEmitter.addListener(RNCallKeepDidToggleSpeakerAction, (data) => handler(data));
